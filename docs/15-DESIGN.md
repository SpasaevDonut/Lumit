...
- British English, sentence case, calm, no exclamation marks, no emoji. UI strings go through
  the i18n table (K-005) — `flutter_ui/lib/l10n/app_en.arb`, translated on Crowdin (K-298).
...
- **A tooltip is a name, not a lesson**: under five words, two where two will do
  ([07-UI-SPEC.md](07-UI-SPEC.md) §13.2, K-298). Explanation belongs in the settings row's
