...
class BridgeLib
  ...
  @override
  int get rustContentHash => -1191331275;
...
class BridgeLibApiImpl extends BridgeLibApiImplPlatform
  ...
  BridgeMask dco_decode_bridge_mask(dynamic raw) {
    ...
    return BridgeMask(
      ...
      feather: dco_decode_f_64(arr[7]),
      expansion: dco_decode_f_64(arr[8]),
    );
  }
  ...
  BridgeMask sse_decode_bridge_mask(SseDeserializer deserializer) {
    ...
    var var_feather = sse_decode_f_64(deserializer);
    var var_expansion = sse_decode_f_64(deserializer);
    return BridgeMask(
        id: var_id,
        name: var_name,
  ...
  void sse_encode_bridge_mask(BridgeMask self, SseSerializer serializer) {
    ...
    sse_encode_f_64(self.feather, serializer);
    sse_encode_f_64(self.expansion, serializer);
  }
