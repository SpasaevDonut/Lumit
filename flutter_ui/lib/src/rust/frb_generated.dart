...
class BridgeLib
  ...
  @override
  int get rustContentHash => -315831326;
...
abstract class BridgeLibApi extends BaseApi {
  ...
  LayerReference crateApiCompositionCompositionReferencePrecomposeLayers(
      {required CompositionReference that,
      required List<LayerReference> layers,
      String? name});

  LayerReference? crateApiLayerLayerReferenceSplitAt(
      {required LayerReference that, required PlatformInt64 frame});

  void crateApiLayerLayerReferenceMoveInTo(
      {required LayerReference that, required PlatformInt64 frame});

  void crateApiLayerLayerReferenceMoveOutTo(
      {required LayerReference that, required PlatformInt64 frame});

  void crateApiLayerLayerReferenceTrimInTo(
      {required LayerReference that, required PlatformInt64 frame});

  void crateApiLayerLayerReferenceTrimOutTo(
      {required LayerReference that, required PlatformInt64 frame});
...
class BridgeLibApiImpl extends BridgeLibApiImplPlatform
  ...
  LayerReference? crateApiLayerLayerReferenceSplitAt(
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_opt_box_autoadd_layer_reference,
        decodeErrorData:
            sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBridgeError,
      ),
  ...
  void crateApiLayerLayerReferenceMoveInTo(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceMoveInToConstMeta,
      argValues: [that, frame],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceMoveInToConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_move_in_to",
        argNames: ["that", "frame"],
      );
  ...
  void crateApiLayerLayerReferenceMoveOutTo(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceMoveOutToConstMeta,
      argValues: [that, frame],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceMoveOutToConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_move_out_to",
        argNames: ["that", "frame"],
      );
  ...
  void crateApiLayerLayerReferenceTrimInTo(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceTrimInToConstMeta,
      argValues: [that, frame],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceTrimInToConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_trim_in_to",
        argNames: ["that", "frame"],
      );
  ...
  void crateApiLayerLayerReferenceTrimOutTo(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceTrimOutToConstMeta,
      argValues: [that, frame],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceTrimOutToConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_trim_out_to",
        argNames: ["that", "frame"],
      );
  ...
  LayerReference crateApiCompositionCompositionReferencePrecomposeLayers(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCompositionCompositionReferencePrecomposeLayersConstMeta,
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferencePrecomposeLayersConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_precompose_layers",
  ...
  BridgeLayerInfo dco_decode_bridge_layer_info(dynamic raw) {
    ...
    return BridgeLayerInfo(
      ...
      masks: dco_decode_list_bridge_mask(arr[15]),
    );
  }
