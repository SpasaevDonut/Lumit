...
<Shot file="keyframes-lane.png" caption="Keyframes on a property lane." />
...
note where something should happen. **Beat markers** are markers generated from audio
onset detection - see [Markers](/use/markers/).
